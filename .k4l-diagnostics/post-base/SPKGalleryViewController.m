...
- (void)setupEmptyState {
    ...
    subtitle.text = @"Media you save with K4L will appear here.";
...
- (void)updateEmptyState {
    ...
    if (query.length > 0) {
        ...
        subtitle = @"Media you save with K4L will appear here.";
    }
...
- (void)setupFetchedResultsController {
    ...
    if (![_fetchedResultsController performFetch:&error]) {
        SPKLog(@"General", @"[K4L Gallery] Fetch failed: %@", error);
    }
}
...
- (void)refetch {
    ...
    NSError *error;
    if (![_fetchedResultsController performFetch:&error]) {
        SPKLog(@"General", @"[K4L Gallery] Refetch failed: %@", error);
    }
    [self reloadSubfolders];
    [self.collectionView reloadData];
    [self updateEmptyState];
