...
static NSDictionary *SCIFeatureDefaults(void) {
    NSMutableDictionary *defaults = [@{
        ...
        @"general_detect_duplicate_downloads": @(YES),
        @"general_download_max_concurrent": @(2),
        @"general_download_history_limit": @(300),
        ...
        @"general_audio_page_default_action": @"none",
        ...
        @"interface_disable_follow_button_edr": @(NO),
