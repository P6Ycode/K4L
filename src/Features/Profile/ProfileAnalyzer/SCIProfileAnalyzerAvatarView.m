...
@interface SCIProfileAnalyzerAvatarView ()
@property (nonatomic, strong) UIImageView *imageView;
@property (nonatomic, strong) UIImageView *placeholderView;
@property (nonatomic, copy) NSString *currentPK;
@end

@implementation SCIProfileAnalyzerAvatarView
...
- (void)configureWithPK:(NSString *)pk urlString:(NSString *)urlString {
    ...
    UIImage *warm = [[SCIProfileAnalyzerAvatarCache shared] cachedImageForPK:pk];
    if (warm) {
    ...
    [[SCIProfileAnalyzerAvatarCache shared] avatarForPK:pk urlString:urlString completion:^(UIImage *image) {
