...
NSArray<NSDictionary *> *SCINotificationPreferenceSections(void) {
    return @[
        @{@"title": @"Action Buttons", @"items": @[
            ...
            SCINotificationItem(kSCINotificationDownloadAudio, @"Save Audio to Files", @"audio_download"),
            SCINotificationItem(kSCINotificationDownloadAudioShare, @"Share Audio", @"share"),
            SCINotificationItem(kSCINotificationDownloadAudioGallery, @"Save Audio to Gallery", @"media"),
            SCINotificationItem(kSCINotificationPlayAudio, @"Play Audio", @"play"),
            SCINotificationItem(kSCINotificationCopyAudioURL, @"Copy Download URL", @"link"),
        ]},
        @{@"title": @"Stories", @"items": @[
