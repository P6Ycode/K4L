...
FOUNDATION_EXPORT NSNotificationName const SCIHideUIOnCapturePreferenceDidChangeNotification;
...
/// IG-styled glyph via `+[SCIAssetUtils instagramIconNamed:]`. Clears `symbolName`.
