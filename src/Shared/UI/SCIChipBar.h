...
@protocol SCIChipBarDelegate <NSObject>
@optional
...
- (void)chipBar:(SCIChipBar *)bar didChangeSelection:(NSSet<NSNumber *> *)selectedIndices;
...
@interface SCIChipBar : UIView

@property (nonatomic, weak, nullable) id<SCIChipBarDelegate> delegate;
