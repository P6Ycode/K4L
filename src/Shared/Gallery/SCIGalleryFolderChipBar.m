...
@interface SCIGalleryFolderChipBar ()
...
@implementation SCIGalleryFolderChipBar
...
- (UIButton *)chipForName:(NSString *)name count:(NSInteger)count index:(NSInteger)index {
    ...
    UIImage *icon = [SCIAssetUtils instagramIconNamed:@"folder"
                                            pointSize:14.0
    ...
    chip.tintColor = [SCIUtils SCIColor_InstagramPrimaryText];
