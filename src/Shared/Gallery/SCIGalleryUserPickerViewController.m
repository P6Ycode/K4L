...
@interface SCIGalleryUserPickerViewController () <UISearchResultsUpdating, UISearchBarDelegate>
...
@implementation SCIGalleryUserPickerViewController
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *done = [[UIBarButtonItem alloc] initWithImage:[SCIAssetUtils instagramIconNamed:@"check" pointSize:24.0]
    ...
    UIBarButtonItem *clear = [[UIBarButtonItem alloc] initWithImage:[SCIAssetUtils instagramIconNamed:@"circle_xmark" pointSize:24.0]
                                                              style:UIBarButtonItemStylePlain
                                                             target:self
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backgroundColor = [SCIUtils SCIColor_InstagramBackground];
...
- (void)applySelectionAccessoryToCell:(UITableViewCell *)cell selected:(BOOL)selected {
    ...
    iconView.image = [SCIAssetUtils instagramIconNamed:(selected ? @"circle_check_filled" : @"circle") pointSize:24.0];
