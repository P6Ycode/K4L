...
+ (NSArray<SCIActionDescriptor *> *)descriptors {
    ...
    dispatch_once(&onceToken, ^{
        descriptors = @[
            ...
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionDownloadAudio title:@"Download Audio" iconName:@"audio"],
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionDownloadAudioShare title:@"Download Audio & Share" iconName:@"share"],
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionDownloadAudioGallery title:@"Download Audio to Gallery" iconName:@"media"],
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionPlayAudio title:@"Play Audio" iconName:@"play"],
            [SCIActionDescriptor descriptorWithIdentifier:kSCIActionCopyAudioURL title:@"Copy Audio URL" iconName:@"link"],
