...
@interface SCIBulkSelectionItem : NSObject
...
typedef void (^SCIBulkSelectionCompletion)(NSIndexSet *selectedIndexes,
                                           NSString *destinationIdentifier);

@interface SCIBulkMediaSelectionViewController : UIViewController
