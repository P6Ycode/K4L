...
typedef void (^SCITrimRenderProgressBlock)(double progress);
typedef void (^SCITrimRenderCompletionBlock)(NSURL *_Nullable outputURL, NSError *_Nullable error);
...
@interface SCITrimRenderer : NSObject
...
+ (void)renderTrimForSourceURL:(NSURL *)sourceURL
               ...
               durationSeconds:(NSTimeInterval)durationSeconds
                      ...
                      progress:(nullable SCITrimRenderProgressBlock)progress
