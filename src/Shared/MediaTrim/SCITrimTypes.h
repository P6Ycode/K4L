...
typedef NS_ENUM(NSInteger, SCITrimMediaKind) {
    SCITrimMediaKindVideo = 0,
    SCITrimMediaKindAudio = 1,
};
...
typedef NS_ENUM(NSInteger, SCITrimResultMode) {
    SCITrimResultModeTrimmedVideo = 0,
    SCITrimResultModeSingleFrame  = 1,
    SCITrimResultModeTrimmedAudio = 2,
};
