...
static NSDictionary<NSString *, SCIAssetDescriptor *> *SCIAssetOverrides(void) {
    ...
    dispatch_once(&onceToken, ^{
        overrides = @{
            ...
            @"play": @{@"candidates": @[@"ig_icon_play_prism_outline_24", @"ig_icon_play_outline_24", @"ig_icon_add_outline_24"]},
            ...
            @"sticker": @{@"candidates": @[@"ig_icon_sticker_no_face_pano_outline_24"]},
            ...
            @"undo": @{@"candidates": @[@"ig_icon_undo_circle_outline_24"]},
